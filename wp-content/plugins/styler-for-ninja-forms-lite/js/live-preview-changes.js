...
wp.customize( 'nf_styler_form_id_' + urlParams + '[dropdown-fields][padding-top]', function( value ) {
  ...
  // ***** end padding ****
	...
	wp.customize( 'nf_styler_form_id_' + urlParams + '[radio-inputs][padding-top]', function( value ) {
		...
		value.bind( function( to ) {
			to = addPxToValue( to );
				$( '#nf-form-' + urlParams + '-cont .listradio-container .nf-field-element label' ).css( 'padding-top', to );
			 } );
	  } );
	  ...
	  wp.customize( 'nf_styler_form_id_' + urlParams + '[radio-inputs][padding-right]', function( value ) {
		...
		value.bind( function( to ) {
			to = addPxToValue( to );
				$( '#nf-form-' + urlParams + '-cont .listradio-container .nf-field-element label' ).css( 'padding-right', to );
			 } );
	  } );
	  ...
	  wp.customize( 'nf_styler_form_id_' + urlParams + '[radio-inputs][padding-bottom]', function( value ) {
		...
		value.bind( function( to ) {
			to = addPxToValue( to );
				$( '#nf-form-' + urlParams + '-cont .listradio-container .nf-field-element label' ).css( 'padding-bottom', to );
			 } );
	  } );
	  ...
	  wp.customize( 'nf_styler_form_id_' + urlParams + '[radio-inputs][padding-left]', function( value ) {
		...
		value.bind( function( to ) {
			to = addPxToValue( to );
				$( '#nf-form-' + urlParams + '-cont .listradio-container .nf-field-element label' ).css( 'padding-left', to );
			 } );
	  } );
	...
	//   } );
	  ...
	  wp.customize( 'nf_styler_form_id_' + urlParams + '[checkbox-inputs][padding-top]', function( value ) {
		...
		value.bind( function( to ) {
			to = addPxToValue( to );
				$( '#nf-form-' + urlParams + '-cont .listcheckbox-wrap .nf-field-element label' ).css( 'padding-top', to );
			 } );
	  } );
	  ...
	  wp.customize( 'nf_styler_form_id_' + urlParams + '[checkbox-inputs][padding-right]', function( value ) {
		...
		value.bind( function( to ) {
			to = addPxToValue( to );
				$( '#nf-form-' + urlParams + '-cont .listcheckbox-wrap .nf-field-element label' ).css( 'padding-right', to );
			 } );
	  } );
	  ...
	  wp.customize( 'nf_styler_form_id_' + urlParams + '[checkbox-inputs][padding-bottom]', function( value ) {
		...
		value.bind( function( to ) {
			to = addPxToValue( to );
				$( '#nf-form-' + urlParams + '-cont .listcheckbox-wrap .nf-field-element label' ).css( 'padding-bottom', to );
			 } );
	  } );
	  ...
	  wp.customize( 'nf_styler_form_id_' + urlParams + '[checkbox-inputs][padding-left]', function( value ) {
		...
		value.bind( function( to ) {
			to = addPxToValue( to );
				$( '#nf-form-' + urlParams + '-cont .listcheckbox-wrap .nf-field-element label' ).css( 'padding-left', to );
			 } );
	  } );
