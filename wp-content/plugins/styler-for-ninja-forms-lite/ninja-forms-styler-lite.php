...
class NF_Styler_Customizer_Lite {
	...
	function get_form_styles( $form_id, $category ) {
		...
		$input_styles .= empty( $settings[ $category ]['padding-left'] ) ? '' : 'padding-left:' . $settings[ $category ]['padding-left'] . $this->nf_styler_add_px_to_value( $settings[$category]['padding-left'] )  . ';';
		$input_styles .= empty( $settings[ $category ]['padding-right'] ) ? '' : 'padding-right:' . $settings[ $category ]['padding-right'] . $this->nf_styler_add_px_to_value( $settings[$category]['padding-right'] )  . ';';
		$input_styles .= empty( $settings[ $category ]['padding-top'] ) ? '' : 'padding-top:' . $settings[ $category ]['padding-top'] . $this->nf_styler_add_px_to_value( $settings[$category]['padding-top'] )  . ';';
		$input_styles .= empty( $settings[ $category ]['padding-bottom'] ) ? '' : 'padding-bottom:' . $settings[ $category ]['padding-bottom'] . $this->nf_styler_add_px_to_value( $settings[$category]['padding-bottom'] )  . ';';

		$input_styles .= empty( $settings[ $category ]['margin-left'] ) ? '' : 'margin-left:' . $settings[ $category ]['margin-left'] . $this->nf_styler_add_px_to_value( $settings[$category]['margin-left'] ) . ';';
		$input_styles .= empty( $settings[ $category ]['margin-right'] ) ? '' : 'margin-right:' . $settings[ $category ]['margin-right'] . $this->nf_styler_add_px_to_value( $settings[$category]['margin-right'] ) . ';';
		$input_styles .= empty( $settings[ $category ]['margin-top'] ) ? '' : 'margin-top:' . $settings[ $category ]['margin-top'] . $this->nf_styler_add_px_to_value( $settings[$category]['margin-top'] ) . ';';
		$input_styles .= empty( $settings[ $category ]['margin-bottom'] ) ? '' : 'margin-bottom:' . $settings[ $category ]['margin-bottom'] . $this->nf_styler_add_px_to_value( $settings[$category]['margin-bottom'] ) . ';';
